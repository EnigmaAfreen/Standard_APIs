...
@Entity
@Data
public class BTVL_MST_BOE_ITEM_TBL {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "oracle_sequence")
    @SequenceGenerator(name = "oracle_sequence", sequenceName = "BTVL_MST_BOE_ITEM_TBL_SEQ", allocationSize = 1)
    @Column(name = "ITEM_ID")
    ...
    @Column(name = "EXEMPTION_NOTIF_NO")
    private String exemptionNotifNo;
